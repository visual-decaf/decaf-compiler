...
TEST_CASE("double_type_json", "[type]") {
    using namespace decaf;
    Type double_type;
    double_type.classification = Type::Classification::DOUBLE;
...
TEST_CASE("invalid_type_json", "[type]") {
    using namespace decaf;
    Type invalid_type;
    invalid_type.classification = Type::Classification::INVALID;
...
TEST_CASE("bool_type_json", "[type]") {
    using namespace decaf;
    Type bool_type;
    bool_type.classification = Type::Classification::BOOL;
